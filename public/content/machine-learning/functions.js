...
var StepFunctions = (() => {
  ...
  // content/machine-learning/functions.ts
  var functions_exports = {};
  __export(functions_exports, {
    logisticAnimationExercise: () => logisticAnimationExercise
  });
  ...
  function sigmoid(a, b) {
    return (x) => 1 / (1 + Math.exp(-(a + b * x)));
  }
  function logisticAnimationExercise($step) {
