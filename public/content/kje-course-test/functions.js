...
var StepFunctions = (() => {
  ...
  // content/kje-course-test/functions.ts
  ...
  function drawSVG(obj, options = {}) {
    ...
    if (isRectangle(obj)) {
      ...
      const radius2 = Math.min(options.cornerRadius, rect.w / 2, rect.h / 2);
      return drawRoundedRect(rect, radius2);
    }
    return "";
  }
  ...
  function similar($step) {
    ...
    $N("circle", { class: "handle fixed", r: 10, cx: 320, cy: 180, target: "greenCircle", style: "fill: #22ab24" }, $svg);
    $N("circle", { class: "outline", r: 60, cx: 320, cy: 180, target: "greenCircle", style: "stroke: #22ab24" }, $strokes);
    ...
    for (const c of circles) {
      ...
      const $outline = $N("circle", { class: "outline", target: "redCircle", r: c[2] }, $strokes);
